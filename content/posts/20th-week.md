...
However, this seems quite evil, and maybe we should not try to do that and accept that in this case we would define `X` to be a small type in the definition of ITrees. 
